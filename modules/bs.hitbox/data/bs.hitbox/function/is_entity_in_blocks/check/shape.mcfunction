...
execute store result score #i bs.ctx run data get storage bs:ctx _.shape[-1][0] 62500
execute store result score #j bs.ctx run data get storage bs:ctx _.shape[-1][1] 62500
execute store result score #k bs.ctx run data get storage bs:ctx _.shape[-1][2] 62500
execute store result score #o bs.ctx run data get storage bs:ctx _.shape[-1][3] 62500
execute store result score #p bs.ctx run data get storage bs:ctx _.shape[-1][4] 62500
execute store result score #q bs.ctx run data get storage bs:ctx _.shape[-1][5] 62500
