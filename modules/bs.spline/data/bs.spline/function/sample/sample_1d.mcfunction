...
execute if score #t bs.ctx matches ..1000 run function bs.spline:utils/compute_1d
...
$execute if score #t bs.ctx matches ..999 run function bs.spline:sample/sample_1d {type:"$(type)"}
