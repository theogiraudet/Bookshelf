...
scoreboard players operation #z bs.ctx *= #l bs.ctx
...
scoreboard players operation #z bs.ctx /= -1000 bs.const
scoreboard players operation #z bs.ctx += #j bs.ctx
scoreboard players operation #z bs.ctx *= #t bs.ctx
scoreboard players operation #z bs.ctx /= -1000 bs.const
execute store result storage bs:lambda spline.point[2] double -.001 run scoreboard players operation #z bs.ctx -= #i bs.ctx
