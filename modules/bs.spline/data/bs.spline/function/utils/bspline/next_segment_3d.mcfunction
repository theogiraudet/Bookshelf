...
execute store result score #k bs.ctx run data get storage bs:ctx _.points[1][2] 1000
execute store result score #j bs.ctx run data get storage bs:ctx _.points[2][2] 1000
...
scoreboard players operation #j bs.ctx *= 3 bs.const
scoreboard players operation #k bs.ctx *= 3 bs.const
scoreboard players operation #l bs.ctx += #k bs.ctx
execute store result score #u bs.ctx run scoreboard players operation #k bs.ctx *= -2 bs.const
scoreboard players operation #l bs.ctx -= #j bs.ctx
scoreboard players operation #k bs.ctx += #j bs.ctx
scoreboard players operation #u bs.ctx *= -2 bs.const
scoreboard players operation #u bs.ctx += #j bs.ctx
scoreboard players operation #u bs.ctx /= -18 bs.const
scoreboard players operation #i bs.ctx -= #u bs.ctx
scoreboard players operation #j bs.ctx /= 6 bs.const
scoreboard players operation #k bs.ctx /= 6 bs.const
scoreboard players operation #l bs.ctx /= 6 bs.const
