...
execute store result score #w bs.ctx run scoreboard players operation #j bs.ctx -= #i bs.ctx
...
scoreboard players operation #k bs.ctx *= -2 bs.const
scoreboard players operation #l bs.ctx -= #k bs.ctx
scoreboard players operation #w bs.ctx *= 3 bs.const
scoreboard players operation #l bs.ctx -= #w bs.ctx
scoreboard players operation #k bs.ctx += #j bs.ctx
scoreboard players operation #k bs.ctx -= #l bs.ctx
scoreboard players operation #j bs.ctx /= 2 bs.const
scoreboard players operation #k bs.ctx /= 2 bs.const
scoreboard players operation #l bs.ctx /= 2 bs.const
