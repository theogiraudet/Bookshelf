...
data modify storage bs:out collection set value ["a", "a", "a", "a"]
...
data modify storage bs:out collection set value ["a", "a", "a", "b"]
execute store success score #s bs.ctx run function #bs.collection:all {run: "execute if data storage bs:lambda collection{value: 'a'}"}
...
data modify storage bs:out collection set value [5]
...
# First element fails
data modify storage bs:out collection set value [99, "a", "a"]
execute store success score #s bs.ctx run function #bs.collection:all {run: "execute if data storage bs:lambda collection{value: 'a'}"}
assert score #s bs.ctx matches 0
