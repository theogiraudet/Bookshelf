...
$data modify storage bs:data collection.stack prepend value { value: [], run: "$(run)", result: 0b, consumed: [] }
...
execute if data storage bs:data collection.stack[0].value[0] store success score #s bs.ctx run function bs.collection:internal/any_rec
