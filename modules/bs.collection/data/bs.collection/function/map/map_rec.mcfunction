...
# Call the lambda function to transform the value
function bs.collection:map/call with storage bs:data collection.stack[0]
...
execute if data storage bs:data collection.stack[0].value[0] run function bs.collection:map/map_rec
