...
data modify storage bs:data collection.stack prepend value { value: [], result: [] }

data modify storage bs:data collection.stack[0].value set from storage bs:out collection
execute if data storage bs:data collection.stack[0].value[0] run function bs.collection:internal/flatten_rec
