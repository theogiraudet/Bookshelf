...
execute if predicate {type:"int_value_check",value:{type:storage,storage:"bs.animation:",path:"stack[-1]._[0].i"},test:{min:{type:storage,storage:"bs.animation:",path:"stack[-1]._[0].n"}}} run return run function bs.animation:utils/rotate/e3
...
execute if predicate {type:"float_value_check",value:{type:storage,storage:"bs.animation:",path:"stack[-1]._[0].t"},test:{min:1.0}} run function bs.animation:utils/rotate/l3
