...
execute if predicate {type:"int_value_check",value:{type:storage,storage:"bs.animation:",path:"stack[-1]._[0].i"},test:{max:-1}} run return run function bs.animation:utils/rotate/s2
