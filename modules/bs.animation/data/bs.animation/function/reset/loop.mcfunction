...
$$(run)
data remove storage bs.animation: stack[-1]._[0]._
...
execute if data storage bs.animation: stack[-1]._[0] run function bs.animation:reset/loop with storage bs.animation: stack[-1]._[0]
