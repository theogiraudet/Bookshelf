...
data modify storage bs.animation: stack[-1]._[].t set value 0.0f
data modify storage bs.animation: stack[-1]._[].i set value 0
data remove storage bs.animation: stack[-1]._[].s
data remove storage bs.animation: stack[-1]._[].v
data remove storage bs.animation: stack[-1]._[].l
data remove storage bs.animation: stack[-1]._[].w

function bs.animation:reset/loop with storage bs.animation: stack[-1]._[0]
