...
execute unless data storage bs:data fsm.fsm.test_fsm run say "Failed to create a valid FSM"
...
#   } \
# }
# execute unless score #s bs.ctx matches 0 run say "Failed to return an error when creating a duplicate FSM"
...
#   } \
# }
# execute unless score #s bs.ctx matches 0 run say "Failed to return an error when FSM has no initial state"
...
#   } \
# }
# execute unless score #s bs.ctx matches 0 run say "Failed to return an error when initial state doesn't exist"
...
#   } \
# }
# execute unless score #s bs.ctx matches 0 run say "Failed to return an error when FSM has duplicate state names"
...
#   } \
# }
# execute unless score #s bs.ctx matches 0 run say "Failed to return an error when transition points to non-existent state"
...
#   } \
# }
# execute unless data storage bs:data fsm.fsm.complex_fsm run say "Failed to create a complex FSM with various transition types"
...
#   } \
# }
# execute unless data storage bs:data fsm.fsm.minimal_fsm run say "Failed to create a minimal FSM"
...
#   } \
# }
# execute unless score #s bs.ctx matches 0 run say "Failed to return an error when FSM has unreachable final state"
...
#   } \
# }
# execute unless score #s bs.ctx matches 0 run say "Failed to return an error when FSM has no final state"
