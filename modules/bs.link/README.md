...
- **🔗 Entity Linking**: Create parent-child relationships between entities.
- **🔄 Position Synchronization**: Maintain relative positions between linked entities.
- **🎯 Rotation Control**: Synchronize rotations between parent and child entities.

📚 [Read the full documentation](https://docs.mcbookshelf.dev/en/latest/modules/link.html)
