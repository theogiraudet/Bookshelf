...
- **🎯 Aimed Detection**: Execute commands at aimed blocks, entities, and points.
- **🏗️ Block Placement**: Precise control over block placement positions.
- **👁️ Entity Vision**: Run commands based on entity line of sight.

📚 [Read the full documentation](https://docs.mcbookshelf.dev/en/latest/modules/view.html)
