...
- **❤️ Health Management**: Add, remove, or set health points for entities with precision.
- **💪 Max Health Control**: Modify and manage maximum health values for entities.
- **📊 Health Monitoring**: Get accurate health information while bypassing NBT limitations.
