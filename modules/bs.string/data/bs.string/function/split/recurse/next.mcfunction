...
execute if score #t bs.ctx matches 0 run return run function bs.string:split/recurse/found with storage bs:ctx
...
function bs.string:split/recurse/substr with storage bs:ctx
