...
- **🔄 Command Management**: Cancel specific commands or clear all scheduled tasks.
- **🔍 Context Preservation**: Maintain execution context (entity & location) for scheduled commands.
