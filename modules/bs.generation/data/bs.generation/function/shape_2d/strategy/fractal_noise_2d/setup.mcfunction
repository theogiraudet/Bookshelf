...
execute store result score $random.fractal_noise_2d.seed bs.in run data get storage bs:data generation._.seed
execute store result score $random.fractal_noise_2d.octaves bs.in run data get storage bs:data generation._.octaves
