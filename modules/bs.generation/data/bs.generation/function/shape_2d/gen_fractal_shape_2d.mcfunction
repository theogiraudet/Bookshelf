...
$data modify storage bs:data generation._ merge value {impl:"fractal_noise_2d",cb:'$(run)',w:$(width),h:$(height),x:0,y:0,oy:"~",oz:"~"}
...
execute unless data storage bs:data generation._.seed store result storage bs:data generation._.seed int 1 run random value 1.. bs.generation:fractal_shape_2d
