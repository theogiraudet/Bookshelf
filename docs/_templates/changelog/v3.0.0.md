...
- <abbr title="Enhancements">⚡</abbr> **[#375](https://github.com/mcbookshelf/bookshelf/pull/375)** - Updated `emit_block_particle` and `play_block_sound` to support default values. Added `mode` and `viewers` parameters to `emit_block_particle`.
