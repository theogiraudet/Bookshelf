...
- <abbr title="Enhancements">⚡</abbr> **[#375](https://github.com/mcbookshelf/bookshelf/pull/375)** - Updated `emit_block_particle` to support default values and added `mode` and `viewers` parameters.
